...
VALUES
    (
        'Hello, welcome to our workspace app!',
        1
    ),
    (
        'Learning PostgreSQL JDBC today!',
        2
    );
...
SELECT * FROM greeting_audit;

SELECT get_user_greeting_count('admin_kiran');

SELECT get_user_greeting_count('user_rohan');